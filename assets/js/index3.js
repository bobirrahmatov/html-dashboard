...
// chart6
  ...
  var chart = new Chart(document.getElementById('chart6'), {
	type: 'doughnut',
	data: {
		labels: ["Overdue", "Submitted", "Pending"],
		datasets: [{
			label: "Device Users",
			backgroundColor: ["#e72e2e", "#12bf24", "#ff6632"],
			data: [2, 18, 80]
		}]
	  },
	options: {
...
var options = {
    series: [{
        name: "Pending",
        data: [2, 7, 6, 14, 24, 14, 3, 18, 1]
    },{
        name: "Submitted",
        data: [5, 9, 14, 2, 23, 11, 9, 2, 7]
    }],
    chart: {
        type: "bar",
       // width: 130,
    ...
    colors: ["#ff6632", "#12bf24"],
    xaxis: {
        categories: ["Team 1", "Team 2", "Team 3", "Team 4", "Team 5", "Team 6", "Team 7"]
    },
	grid:{
		show: true,
		borderColor: 'rgba(66, 59, 116, 0.15)',
